...
contract_address = "0x17863d10e2D18425562FE1AbBccaF4E6104FDdF0"
with open("GasOptimization_abi.json") as f:
    contract_abi = json.load(f)
contract = web3.eth.contract(address=contract_address, abi=contract_abi)

# Wallet setup
private_key = "0x92ea9a192186552e217efa6579c406186a174b1c23dfb71dce78dde0b0c25ad6"
sender_address = "0xec7Aed1dF69aE9CcA5EFfCAe6625bb0385D7F194"
...
def compress_and_store(file_path, id):
    ...
    # Compress data with zlib and measure time
